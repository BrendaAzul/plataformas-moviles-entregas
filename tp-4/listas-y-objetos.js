...
function soloMayoresDeEdad(listaDePersonas) {
    ...
    for (let i = 0; i < listaDePersonas.length; i++) {
        // Comprobamos si la persona actual tiene más de 18 años
        if (listaDePersonas[i].edad > 18) {
            // Si es mayor de 18 años, la añadimos al array de personas mayores
            personasMayores.push(listaDePersonas[i]);
        }
    }

    // Devolvemos la lista de personas mayores de 18 años
