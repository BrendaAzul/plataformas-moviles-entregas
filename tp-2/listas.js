...
function calcularPromedio(listaDeNumeros) {
    if (listaDeNumeros.legth===0){
        return 0;
    }
    const sumar= listaDeNumeros.reduce((acumulador,numer)=> acumulador+listaNumerosEjemplo,0);
    const promedio = sumar/listaDeNumeros.legth;
    return promedio;
}
...
function ordenarPalabrasPorLongitud(listaDePalabras) {
    return listaDePalabras.sort((a,b)=>a.legth-b.legth);
}
